...
servidor \texttt{JBoss} dentro da própria IDE. Para isso precisamos criar na IDE
um novo servidor. 

Primeiramente, certifique-se de que você está usando a perspectiva de
desenvolvimento \texttt{Java EE}. No conjunto de abas na parte inferior da IDE,
abaixo da parte onde fica o código, selecione a aba \texttt{servers} como na
imagem \ref{seleciona_server_eclipse} .
