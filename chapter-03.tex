...
\begin{framed}
	\lstinputlisting[language=xml]{files/project.properties-controleacesso}
\end{framed}
...
\texttt{Curso} devem ser visíveis sua \texttt{Visibility} deve ser
\texttt{public}.
Dessa forma, mantenha a \texttt{checkbox} \texttt{Navigable} marcada na
associação para as duas classes. Para isso, clique no botão “...” (reticências)
da tela anterior, como na imagem ~\ref{config_navigable_associacao}.
\begin{figure}[H]
	\centering
