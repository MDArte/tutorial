...
\begin{itemize}
  ...
  \begin{enumerate}
    \item stereotypes - Cada elemento do metamodelo pode ser mapeado por
    de um ou mais estereótipos.
    \item context - Cada elemento do metamodelo pode ser mapeado por um único
    ...
    construído.
    \item properties - Cada elemento do metamodelo pode ser mapeado por uma
    ou mais propriedades que se apliquem a ele.
  \end{enumerate}
