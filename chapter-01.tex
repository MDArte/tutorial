...
\begin{itemize}
  \item Máquina Virtual \texttt{Java} - \texttt{JDK}
  \item \texttt{JBoss} (versão 4.2.3-GA)
  \item \texttt{Maven} (versão 1.0.2) 
  \item \texttt{Magic Draw} (versão 9.5)
  \item \texttt{Eclipse Indigo} (versão 3.7.1)
\end{itemize}
...
O \texttt{Jboss} disponibilizado já está configurado adequadamente para os exemplos
